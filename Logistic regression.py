...
dataset = pd.read_csv(r"C:\Users\Shalu\OneDrive\Desktop\FSDS (Jai shree ram)\Sep'25\3rd Logistic Regrassion\2.LOGISTIC REGRESSION CODE\logit classification.csv")
